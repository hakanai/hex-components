 ...
 * @author trejkaz
 */
public class MacNSDateInterpreterInfo extends AbstractInterpreterInfo {
    public MacNSDateInterpreterInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.MacNSDate"));
    }
