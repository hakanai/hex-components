 ...
 * @author trejkaz
 */
public class MacClassicDateInterpreterInfo extends AbstractInterpreterInfo {
    public MacClassicDateInterpreterInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.MacClassicDate"));
    }
