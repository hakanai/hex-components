 ...
 * @author trejkaz
 */
public class Float32InterpreterLEInfo extends AbstractInterpreterInfo {
    public Float32InterpreterLEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.Float32LE"));
    }
