 ...
 * @author trejkaz
 */
public class ULongInterpreterBEInfo extends AbstractInterpreterInfo {
    public ULongInterpreterBEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.UInt64BE"));
    }
