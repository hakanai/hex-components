 ...
 * @author trejkaz
 */
public class UShortInterpreterLEInfo extends AbstractInterpreterInfo {
    public UShortInterpreterLEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.UInt16LE"));
    }
