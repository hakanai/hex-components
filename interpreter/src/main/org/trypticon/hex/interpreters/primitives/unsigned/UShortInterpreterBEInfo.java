 ...
 * @author trejkaz
 */
public class UShortInterpreterBEInfo extends AbstractInterpreterInfo {
    public UShortInterpreterBEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.UInt16BE"));
    }
