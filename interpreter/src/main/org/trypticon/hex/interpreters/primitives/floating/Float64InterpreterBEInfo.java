 ...
 * @author trejkaz
 */
public class Float64InterpreterBEInfo extends AbstractInterpreterInfo {
    public Float64InterpreterBEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.Float64BE"));
    }
