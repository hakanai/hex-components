 ...
 * @author trejkaz
 */
public class Float128InterpreterLEInfo extends AbstractInterpreterInfo {
    public Float128InterpreterLEInfo() {
        super(new LocalisedName("org/trypticon/hex/interpreters/Bundle", "Interpreters.Float128LE"));
    }
