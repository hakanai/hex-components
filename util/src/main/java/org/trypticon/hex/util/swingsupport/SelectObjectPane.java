...
public abstract class SelectObjectPane<E> extends ValidatingPanel {
    ...
    protected SelectObjectPane() {
        ...
        list.getRowSorter().addRowSorterListener(new RowSorterListener() {
            @Override
    ...
    /**
     * Workaround for SwingX not having the generics which should be present on {@link javax.swing.ListModel}.
     *
